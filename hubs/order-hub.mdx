...
For the complete list of endpoints, filters, includes, and validation rules (e.g. cart filter by `session_uuid`, checkout required fields), see the [API Reference](/api-reference/get-integrations) (OpenAPI).
</Callout>
