...
For the complete list of ProductHub filters (e.g. `anchor_category_id`, `exclude_child_products`, `exclude_parent_products`, `search`, `attribute`), includes, and validation rules, see the [API Reference](/api-reference/get-integrations) (OpenAPI).
</Callout>
